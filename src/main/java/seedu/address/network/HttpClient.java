...
public class HttpClient {
    ...
    private static final int CONNECTION_TIMEOUT_MILLIS = 1000 * 10; // 5 seconds
    private static final int READ_TIMEOUT_MILLIS = 1000 * 10; // 5 seconds
    private static final int REQUEST_TIMEOUT_MILLIS = 1000 * 10; // 5 seconds
