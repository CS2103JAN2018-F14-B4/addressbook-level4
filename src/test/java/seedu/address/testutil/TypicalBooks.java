...
public class TypicalBooks {
    ...
    public static final Book ARTEMIS = new BookBuilder().withAuthors("Andy Weir").withTitle("Artemis")
            .withCategories("Fiction").withDescription("This is Artemis.").withRating(-1)
            .withPriority("LOW").withStatus("UNREAD").withGid("ry3GjwEACAAJ")
    ...
    public static final Book BABYLON_ASHES = new BookBuilder().withAuthors("James S. A. Corey")
            ...
            .withRating(-1).withPriority("LOW").withStatus("UNREAD")
    ...
    public static final Book COLLAPSING_EMPIRE = new BookBuilder().withAuthors("John Scalzi")
            ...
            .withDescription("This is The Collapsing Empire.").withRating(-1).withPriority("LOW")
            .withStatus("UNREAD").withGid("2SoaDAAAQBAJ")
    ...
    public static final Book CONSIDER_PHLEBAS = new BookBuilder().withAuthors("Iain M. Banks")
            ...
            .withDescription("This is Consider Phlebas.").withRating(-1).withPriority("LOW").withStatus("UNREAD")
            .withGid("3_bJKlAOecEC")
    ...
    public static final Book WAKING_GODS = new BookBuilder().withAuthors("Sylvain Neuvel").withTitle("Waking Gods")
            ...
            .withRating(-1).withPriority("LOW").withStatus("UNREAD").withGid("CIj1DAAAQBAJ")
            .withIsbn("9781405921909").withPublisher("Penguin UK")
