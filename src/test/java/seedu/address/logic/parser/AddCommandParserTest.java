...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Book expectedBook = new BookBuilder().withTitle(VALID_TITLE_ARTEMIS)
                ...
                .withDescription(VALID_DESCRIPTION_ARTEMIS)
                .withRate(VALID_RATE_ARTEMIS).build();

        // whitespace only preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + TITLE_DESC_ARTEMIS + AUTHOR_DESC_ARTEMIS
                + CATEGORY_DESC_ARTEMIS + DESCRIPTION_DESC_ARTEMIS + RATE_DESC_ARTEMIS, new AddCommand(expectedBook));
        ...
        assertParseSuccess(parser, TITLE_DESC_ARTEMIS + AUTHOR_DESC_ARTEMIS + CATEGORY_DESC_ARTEMIS
                + DESCRIPTION_DESC_BABYLON + DESCRIPTION_DESC_ARTEMIS + RATE_DESC_ARTEMIS, new AddCommand(expectedBook));
        ...
        assertParseSuccess(parser, TITLE_DESC_ARTEMIS + AUTHOR_DESC_ARTEMIS + AUTHOR_DESC_BABYLON
                + CATEGORY_DESC_ARTEMIS + DESCRIPTION_DESC_ARTEMIS + RATE_DESC_ARTEMIS, new AddCommand(expectedBookMultipleAuthors));
        ...
        assertParseSuccess(parser, TITLE_DESC_ARTEMIS + AUTHOR_DESC_ARTEMIS + CATEGORY_DESC_BABYLON
                + CATEGORY_DESC_ARTEMIS + DESCRIPTION_DESC_ARTEMIS + RATE_DESC_ARTEMIS, new AddCommand(expectedBookMultipleCategories));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_TITLE_ARTEMIS + AUTHOR_DESC_ARTEMIS
                + CATEGORY_DESC_ARTEMIS + DESCRIPTION_DESC_ARTEMIS + RATE_DESC_ARTEMIS, expectedMessage);

        // missing description prefix
        assertParseFailure(parser, TITLE_DESC_ARTEMIS + AUTHOR_DESC_ARTEMIS
                + CATEGORY_DESC_ARTEMIS + VALID_DESCRIPTION_ARTEMIS + VALID_RATE_ARTEMIS, expectedMessage);
        ...
        assertParseFailure(parser, TITLE_DESC_ARTEMIS + AUTHOR_DESC_ARTEMIS
                + VALID_CATEGORY_ARTEMIS + DESCRIPTION_DESC_ARTEMIS + RATE_DESC_ARTEMIS, expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_TITLE_ARTEMIS + VALID_AUTHOR_ARTEMIS
                + VALID_CATEGORY_ARTEMIS + VALID_DESCRIPTION_ARTEMIS + VALID_RATE_ARTEMIS, expectedMessage);
    }
}
