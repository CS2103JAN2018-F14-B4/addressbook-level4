...
import static seedu.address.logic.commands.CommandTestUtil.VALID_RATE_ARTEMIS;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + TITLE_DESC_ARTEMIS + AUTHOR_DESC_ARTEMIS
                + CATEGORY_DESC_ARTEMIS + DESCRIPTION_DESC_ARTEMIS + RATE_DESC_ARTEMIS,
        ...
        assertParseSuccess(parser, TITLE_DESC_ARTEMIS + AUTHOR_DESC_ARTEMIS + CATEGORY_DESC_ARTEMIS
                + DESCRIPTION_DESC_BABYLON + DESCRIPTION_DESC_ARTEMIS + RATE_DESC_ARTEMIS,
                new AddCommand(expectedBook));
