...
** Add an ecrypt data function to let bookshelf.xml to be encrypted when user set a key.
...
*** Added my major and minor feature into UserGuide and DeveloperGuide.
** Community:
