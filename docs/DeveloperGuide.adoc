...
** Add `rating`, `set status` and `change priority` command that allows user to rate, set status and change priority of
some books.
...
** Add a `set aliases` command that allows users to change the current full commands to the aliases that users need.
