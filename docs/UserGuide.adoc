...
image::EditCommandStart.png[width="675"]
...
image::EditCommandMid.png[width="675"]
...
image::CommandAutocorrection.png[width="675"]
...
|*Set a new password* |`setpw [old/OLDPW] [new/NEWPW]`
